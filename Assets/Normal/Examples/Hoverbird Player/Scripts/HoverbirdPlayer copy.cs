...
//             #if UNITY_EDITOR
//                 inputMovement.x = Input.GetAxisRaw("Horizontal") * 3f;
//                 inputMovement.z = Input.GetAxisRaw("Vertical")   * 3f;
//             #endif
...
//                 // inputMovement.x = OVRInput.Get(OVRInput.RawAxis2D.LThumbstick);
//                 // inputMovement.z = OVRInput.Get(OVRInput.RawAxis2D.LThumbstick);
